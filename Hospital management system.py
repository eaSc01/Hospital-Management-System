    ...
    if a == 1:
        while True:
            ...
            query = "Insert into staff values({},'{}','{}','{}','{}',{},'{}','{}','{}')".format(
                ID, Name, FNAME, Date_of_joining, Designation, Salary, DOB, NATIONALITY, CONTACT)
            ...
            x = int(
                input("ENTER 1 TO ADD MORE ENTERIES\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
            if x == 2:
                break
    elif a == 2:
        ...
        if b == 1:
            while True:
                ...
                ID = int(input("ENTER STAFF ID:"))
                Name = input("ENTER NAME:")
                query = "update staff set Name='{}' where ID={}".format(
                    Name, ID)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE NAMES OF STAFF(s)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 2:
            while True:
                ...
                ID = int(input("ENTER STAFF ID:"))
                FNAME = input("ENTER FATHER'S NAME:")
                query = "update staff set FNAME='{}' where ID={}".format(
                    FNAME, ID)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE FATHER'S NAMES OF STAFF(s)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 3:
            while True:
                ...
                query = "update staff set Date_of_joining='{}' where ID={}".format(
                    Date_of_joining, ID)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE DATES OF STAFF(S)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 4:
            while True:
                ...
                ID = int(input("ENTER STAFF ID:"))
                Designation = input("ENTER DESIGNATION:")
                query = "update staff set Designation='{}' where ID={}".format(
                    Designation, ID)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE DESIGNATION OF STAFF(S)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 5:
            while True:
                ...
                query = "update staff set Salary='{}' where ID={}".format(
                    Salary, ID)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE SALARIES OF STAFF(S)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 6:
            while True:
                ...
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE DOB OF STAFF(S)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 7:
            while True:
                ...
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE NATIONALITY OF STAFF(s)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 8:
            while True:
                ...
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE CONTACTS OF STAFF(s)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        ...
        while True:
            ...
            x = int(
                input("ENTER 1 TO DELETE MORE STAFF RECORDS\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
            if x == 2:
                break
    elif a == 4:
        ...
        if c == 1:
            while True:
                ...
                x = int(
                    input("ENTER 1 TO FETCH MORE DATA\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif c == 2:
            while True:
...
# PATIENTS
    ...
    if a == 1:
        while True:
            ...
            DURATION = int(
                input("ENTER PATIENT'S TOTAL DURATION (IN DAYS) IN HOSPITAL:"))
            STATUS = input("ENTER STATUS OF PATIENT:")
            CONTACT = input("ENTER E-MAIL OR CONTACT NUMBER:")
            NATIONALITY = input("ENTER NATIONALITY:")
            DOB = input("ENTER DATE OF BIRTH:")
            BILL = int(input("ENTER TOTAL CHARGES TO BE PAID:"))
            query = "Insert into patients values({},'{}','{}','{}',{},'{}','{}','{}','{}',{})".format(
                PIT, NAME, FNAME, HEALTH_ISSUE, DURATION, STATUS, CONTACT, NATIONALITY, DOB, BILL)
            cursor.execute(query)
            con.commit()
        ...
        if b == 1:
            while True:
                ...
                PIT = int(input("ENTER PATIENT ID:"))
                NAME = input("ENTER NAME:")
                query = "update patients set NAME='{}' where PIT={}".format(
                    NAME, PIT)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE NAMES OF PATIENT(s)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 2:
            while True:
                ...
                PIT = int(input("ENTER PATIENT ID:"))
                FNAME = input("ENTER FATHER'S NAME:")
                query = "update patients set FNAME='{}' where PIT={}".format(
                    FNAME, PIT)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE FATHER'S NAMES OF PATIENT(s)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 3:
            while True:
                ...
                query = "update patients set HEALTH_ISSUES='{}' where PIT={}".format(
                    HEALTH_ISSUES, PIT)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE HEALTH_ISSUES OF PATIENT(S)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 4:
            while True:
                ...
                PIT = int(input("ENTER PATIENT ID:"))
                DURATION = int(
                    input("ENTER DURATION (WEEKS, ENTER NUMBER ONLY!):"))
                query = "update patients set DURATION='{}' where PIT={}".format(
                    DURATION, PIT)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE DURATION OF PATIENT(S)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 5:
            while True:
                ...
                query = "update patients set STATUS='{}' where PIT={}".format(
                    STATUS, PIT)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE STATUS OF PATIENT(S)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 6:
            while True:
                ...
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE CONTACTS OF PATIENT(s)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 7:
            while True:
                ...
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE NATIONALITY OF PATIENT(s)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 8:
            while True:
                ...
                query = "update patients set DOB='{}' where PIT={}".format(
                    DOB, PIT)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE DOB OF PATIENT(S)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 9:
            while True:
                ...
                query = "update patients set BILL={} where PIT={}".format(
                    BILL, PIT)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
        ...
        while True:
            ...
            if cursor.rowcount > 0:
                ...
                print("DATA NOT FOUND")
            x = int(input(
                "ENTER 1 TO DELETE MORE RECORDS OF PATIENT(S)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
            if x == 2:
                break
...
# AMBULANCES
    ...
    if a == 1:
        while True:
            ...
            CAPACITY = int(
                input("ENTER MAXIMUM CAPACITY OF AMBULANCE CAN CARRY:"))
            FACILITIES = input("ENTER FACILITIES:")
            query = "Insert into AMBULANCES values({},'{}',{},'{}')".format(
                ANO, VEHICLE_NUMBER, CAPACITY, FACILITIES)
            cursor.execute(query)
            con.commit()
            print("DATA INSERTED SUCCESFULLY!")
            if cursor.rowcount > 0:
        ...
        if b == 1:
            while True:
                ...
                query = "update AMBULANCES set VEHICLE_NUMBER='{}' where ANO={}".format(
                    VEHICLE_NUMBER, ANO)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE AMBULANCE ENTRIES(s)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 2:
            while True:
                ...
                query = "update AMBULANCES set CAPACITY='{}' where ANO={}".format(
                    CAPACITY, ANO)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE CAPACITY OF AMBULANCE(S)\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        elif b == 3:
            while True:
                ...
                ANO = int(input("ENTER AMBULANCE NUMBER:"))
                FACILITIES = input("ENTER FACILITIES:")
                query = "update AMBULANCES set FACILITIES='{}' where ANO={}".format(
                    FACILITIES, ANO)
                cursor.execute(query)
                con.commit()
                if cursor.rowcount > 0:
                    ...
                    print("NO DATA FOUND")
                x = int(input(
                    "ENTER 1 TO UPDATE MORE AMBULANCE FACILITIES\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
                if x == 2:
                    break
        ...
        while True:
            ...
            if cursor.rowcount > 0:
                ...
                print("DATA NOT FOUND")
            x = int(input(
                "ENTER 1 TO DELETE MORE AMBULANCE RECORDS\nENTER 2 TO EXIT\n\nENTER COMMAND:"))
            if x == 2:
                break
